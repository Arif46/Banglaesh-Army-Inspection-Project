                ...
                <b-row>
                    <b-col sm="12" md="3" offset-md="1">
                        <div class="company-info">
                            ...
                            <b-button class="mt-3" block size="sm" variant="info" @click="showCard">Contact</b-button>
                        </div>
                    </b-col>
                    <b-col sm="12" md="8">
...
<style>
    ...
    .profile-wrapper .company-info .ribbon-wrapper::after{
        ...
        height: 0;
        width: 0;
        border-left: 20px solid var(--info);
        border-right: 20px solid var(--info);
    ...
    .profile-wrapper .company-info .ribbon-wrapper::before{
        ...
        height: 0;
        width: 0;
        border-bottom: 6px solid #011673;
    ...
    .profile-wrapper .contact-info div{
        padding: 5px 0;
        border-bottom: 1px solid #8825f5;
    }
