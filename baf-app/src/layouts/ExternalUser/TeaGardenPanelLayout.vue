...
import teaGarden from '@/mixins/external-user/tea-garden'
import { mapActions } from 'vuex'
export default {
  name: 'MainLayout',
  mixins: [commonServiceMixin, teaGarden],
  data () {
    return {
      closeSidebar: false,
      panel_id: 7
  ...
  watch: {
    currentLocale: function (newVal, oldVal) {
      if (newVal !== oldVal) {
        ...
        this.localizeTeaGardenPanelDropdown({ value: newVal })
      }
    }
  },
  methods: {
    ...
    ...mapActions({
      ...
      localizeTeaGardenPanelDropdown: 'ExternalUserService/localizeTeaGardenPanelDropdown'
    })
  }
}
</script>
