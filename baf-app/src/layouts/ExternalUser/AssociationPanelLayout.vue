...
import associationPanelMixin from '@/mixins/external-user/association-panel'
import { mapActions } from 'vuex'
export default {
  name: 'MainLayout',
  mixins: [commonServiceMixin, associationPanelMixin],
  data () {
    return {
      closeSidebar: false,
      panel_id: 5
  ...
  watch: {
    currentLocale: function (newVal, oldVal) {
      if (newVal !== oldVal) {
        ...
        this.localizeDropdownEbizPanel({ value: newVal })
      }
    }
  },
  methods: {
    ...
    ...mapActions({
      ...
      localizeDropdownEbizPanel: 'ExternalUserService/localizeDropdowneBizPanel'
    })
  }
}
</script>
