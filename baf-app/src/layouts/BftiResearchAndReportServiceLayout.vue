...
import bftiResearchAndReportServiceMixin from '@/mixins/bfti-research-and-report-service'
import commonServiceMixin from '@/mixins/common-service'
import { mapActions } from 'vuex'

export default {
  name: 'MainLayout',
  mixins: [bftiResearchAndReportServiceMixin, commonServiceMixin],
  data () {
    return {
      closeSidebar: false,
      mixinComponentId: 6
  ...
  watch: {
    currentLocale: function (newVal, oldVal) {
      if (newVal !== oldVal) {
        this.localizeBftiResearchAndReportService({ value: newVal })
  ...
  methods: {
    ...
    ...mapActions({
      localizeBftiResearchAndReportService: 'BftiResearchAndReportService/localizeDropdown',
