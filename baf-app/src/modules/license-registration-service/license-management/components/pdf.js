      ...
      Store.commit('mutateCommonProperties', {
        ...
        pdfContent.push({
          ...
          table: {
            ...
            body: [
              [
                { text: vm.$t('dealer.applicant_name') }, { text: vm.$i18n.locale === 'bn' ? appDetail.details.applicant_name_bn : appDetail.details.applicant_name },
                { text: vm.$t('dealer.father_spouse_name') }, { text: vm.$i18n.locale === 'bn' ? appDetail.details.father_spouse_name_bn : appDetail.details.father_spouse_name }
              ],
              [
                { text: vm.$t('dealer.company_name') }, { text: vm.$i18n.locale === 'bn' ? appDetail.details.company_name_bn : appDetail.details.company_name },
                { text: vm.$t('dealer.dob') }, { text: dateFormat(appDetail.details.dob) }
              ],
              [
                { text: vm.$t('dealer.nid_no') }, { text: vm.$n(appDetail.details.nid_no, { useGrouping: false }) },
                { text: vm.$t('dealer.marital_status') }, { text: vm.getMeritalStatus(appDetail.details.marital_status) }
              ],
              [
                { text: vm.$t('dealer.spouse_nid_no') }, { text: appDetail.details.spouse_nid_no ? vm.$n(appDetail.details.spouse_nid_no, { useGrouping: false }) : '' },
                { text: vm.$t('dealer.father_nid_no') }, { text: appDetail.details.father_nid_no ? vm.$n(appDetail.details.father_nid_no, { useGrouping: false }) : '' }
              ],
              [
                { text: vm.$t('dealer.email') }, { text: appDetail.details.email }, { text: vm.$t('dealer.tin_no') },
                { text: vm.$n(appDetail.details.tin_no, { useGrouping: false }) }
              ],
              [
                { text: vm.$t('dealer.mobile') },
                { text: mobileNumber(appDetail.details.mobile), colSpan: 2 }, '', ''
              ]
            ]
          },
          layout: {
        ...
        pdfContent.push({
          ...
          table: {
            widths: ['20%', '30%', '20%', '30%'],
            body: [
              [{ text: vm.$t('globalTrans.division') }, { text: vm.getDivisionName(appDetail.details.division_id) }, { text: vm.$t('globalTrans.district') }, { text: vm.getDistrictName(appDetail.details.district_id) }],
              [{ text: vm.$t('globalTrans.upazila') }, { text: vm.getUpazillaName(appDetail.details.upazilla_id) }, { text: vm.$t('globalTrans.union') }, { text: vm.getUnionName(appDetail.details.union_id) }],
              [{ text: vm.$t('dealer.village') }, { text: vm.$i18n.locale === 'bn' ? appDetail.details.village_bn : appDetail.details.village, colSpan: 3 }, { text: vm.$i18n.locale === 'bn' ? 'a' : 'b' }, { text: vm.$i18n.locale === 'bn' ? 'a' : 'b' }]
            ]
          },
          layout: {
            fillColor: function (rowIndex, node, columnIndex) {
