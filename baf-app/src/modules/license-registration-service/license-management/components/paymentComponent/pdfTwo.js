...
const exportPdfDetails = async (vm, reportTitle, licenseRegistrationServiceBaseUrl, receipt, application, transactionno) => {
  try {
        ...
        receipt.map((item) => {
            ...
            allRowsHead.push([{ text: vm.getFeeName(item.payment_type), style: 'tableHeader' }, { text: vm.$t('globalTrans.amount'), style: 'tableHeader' }, { text: vm.$n(item.amount), style: 'tableHeader' }, { text: vm.$t('globalTrans.amount'), style: 'tableHeader' }, { text: vm.$n(item.vat) + '% = ' + vm.$n(item.amount_vat), style: 'tableHeader' }, { text: vm.$t('globalTrans.amount'), style: 'tableHeader' }, { text: vm.$n(item.tax) + '% =' + vm.$n(item.amount_tax), style: 'tableHeader' }])
        })
        ...
        allRowsHead.push([{ text: vm.$t('globalTrans.total'), style: 'leftalign' }, { text: '', style: 'leftalign', colSpan: 5 }, { text: '', style: 'tableHeader' }, { text: '', style: 'tableHeader' }, { text: '', style: 'tableHeader' }, { text: '', style: 'tableHeader' }, { text: vm.$n(vm.getTotal(receipt) + vm.getTotalVat(receipt) + vm.getTotalTax(receipt)), style: 'tableHeader' }])
