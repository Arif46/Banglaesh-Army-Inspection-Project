    ...
    <ValidationObserver ref="inputAdd"  v-slot="{ handleSubmit, reset }">
        <b-form @submit.prevent="handleSubmit(saveSettings)" @reset.prevent="reset">
          <b-row>
            ...
            <b-col v-if="inputFields.is_multiple" lg="12" sm="12" md="12" class="text-right">
        ...
        watch: {
          ...
          methods: {
            ...
            saveSettings: function () {
              ...
              const data = Object.assign(this.inputFields, { options: tmpInput, value: tmpInput[0].text })
              const tmp = JSON.parse(JSON.stringify(data))
              this.$emit('addCheckbox', tmp, 'modal-5')
            }
        }
    }
</script>
