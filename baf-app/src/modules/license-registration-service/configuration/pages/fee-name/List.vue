  ...
  <div class="inner-section">
    <card>
      ...
      <template v-slot:searchHeaderTitle>
        <h4 class="card-title">{{ $t('fee_name.fee_name') }}</h4>
      </template>
...
import { feeList, feeToggle } from '../../api/routes'
  ...
  methods: {
    editMethodInParent (item, type) {
      if (type === 1) {
        ...
        this.changeStatus(7, licenseRegistrationServiceBaseUrl, feeToggle, item)
      }
    },
    searchData () {
      this.loadData()
    ...
    async loadData () {
      ...
      const result = await RestApi.getData(licenseRegistrationServiceBaseUrl, feeList, params)
      if (result.success) {
