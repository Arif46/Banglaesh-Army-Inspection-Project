<template>
  <b-container fluid>
    ...
    <b-overlay :show="loading">
        <table style="width:100%" class="text-center">
            <tr>
                ...
                <th style="width:50%;">
                    ...
                    <p style="font-size:12px">{{$t('allocation_management.regional_office')}} <span style="border-bottom:1px dotted black;">{{ getOfficeName(challanData.regional_office_id) }}</span></p>
                </th>
                ...
                <td colspan="3">
                    <table style="width:100%;margin-top:10px" border="1">
                        <tr class="tboder">
                            ...
                            <td  class="text-left" style="border-right:non;width:30%;">&nbsp;{{ $t('allocation_management.all_letter_no') }} - {{ $n(challanData.delivery_order_no, { useGrouping: false }) }}</td>
        ...
        <table style="width:100%;margin-top:60px" class="text-center">
            <tr>
                <td style="width:50%;"><span>{{$t('allocation_dc_office.signature_of_storekeeper')}}</span></td>
                <td style="width:50%;margin-top:10px;">{{$t('allocation_dc_office.signature_of_dc_office')}}</td>
            </tr>
        </table>
    </b-overlay>
  </b-col>
...
export default {
    ...
    created () {
        this.challanData = JSON.parse(JSON.stringify(this.item))
    ...
    methods: {
        ...
        async itemPrice () {
            ...
            if (result.success) {
                ...
                //    const singleItem = this.challanItems.find(challItem => challItem.item_category_id === element.item_category_id)
