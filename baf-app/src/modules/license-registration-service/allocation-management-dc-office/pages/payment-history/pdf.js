...
const exportPdfDetails = async (baseUrl, uri, orgId, items, challanItems, challanData, vm, currentDate) => {
  ...
  try {
        ...
        if (i18n.locale === 'bn') {
          ...
          const allRows = [
            [
              { text: vm.$t('allocation_management.name_or_address'), style: 'td1', alignment: 'center' },
            ...
            [
              { text: vm.$t('allocation_dc_office.dc_office_name') + ' : ' + vm.getDistrictName(challanData.district_id), style: 'td1', alignment: 'center' },
          ...
          const firstrow = []
            ...
            firstrow.push({ text: vm.$t('allocation_management.item_quantity'), alignment: 'center' })
          ...
          const lastwidths = ['7%', '13%', '15%', '10%', '10%', '18%', '15%', '12%']
            ...
            const footerHead = [
              [
                ...
                { text: '', alignment: 'center', style: 'thh' },
                { text: '', alignment: 'left', style: 'thh' }
              ]
            ]
            footerHead.push([
              { text: vm.$t('allocation_dc_office.signature_of_storekeeper'), alignment: 'left', style: 'thh' },
              { text: '', alignment: 'left', style: 'thh' },
              { text: vm.$t('allocation_dc_office.signature_of_dc_office'), alignment: 'left', style: 'thh' }
            ])
            pdfContent.push({
              table: {
                headerRows: 1,
