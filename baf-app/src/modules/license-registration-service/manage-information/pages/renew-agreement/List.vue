            ...
            <div class="row">
              ...
              <div class="col-md-8 text-right">
                ...
                <span v-if="applications.length">
                  <span v-for="(app, index) in applications" :key="index" class="ml-2 badge badge-success"> 1001</span>
                </span>
              ...
              <slot v-if ="columns.filter(item => item.show === '1').length > 0">
                <b-table :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" :sort-direction="sortDirection" head-variant="primary" class="tg" :items="listData" :emptyText="$t('globalTrans.noDataFound')" show-empty bordered hover :fields="columns.filter(item => item.show === '1').sort((a, b) => { return a.order - b.order })">
                  ...
                  <template v-slot:cell(status)="data">
                    <span class="badge badge-primary">{{$t('license_management.agreement')}} {{ data.item.agreement_no ? $t('globalTrans.completed') : $t('globalTrans.pending') }}</span>
                  </template>
...
import { tcbAgreementList } from '../../api/routes'
  ...
  data () {
    return {
      ...
      labelData: [
        ...
        { labels: 'license_management.agreement_no', class: 'text-left', sortable: true, stickyColumn: true, show: '1', order: 2, thStyle: { width: '10%' } },
