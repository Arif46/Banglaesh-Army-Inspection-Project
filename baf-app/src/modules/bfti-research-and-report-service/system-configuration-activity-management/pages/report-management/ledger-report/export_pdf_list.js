      ...
      const reportData = vm.reportData
        const allRowsHead = [
          [
            ...
            { text: ':', style: 'td', alignment: 'center' },
            { text: search.topic ? searchHeaderData.topic : vm.$t('globalTrans.all'), style: 'td', alignment: 'left', bold: true }
          ]
        ]
        pdfContent.push({
          table: {
          ...
          reportData.forEach((item, index) => {
            ...
            allRows.push(
              [
                ...
                { text: (i18n.locale === 'en') ? item.document_type_en : item.document_type_bn, style: 'td', alignment: 'center' },
                { text: title, style: 'td', alignment: 'center' },
                { text: client, style: 'td', alignment: 'center' },
                { text: duration, style: 'td', alignment: 'center' }
              ]
            )
          })
        } else {
