  ...
  try {
    ...
    const allRowsHead = [
      [
        ...
        { text: ':', style: 'td', alignment: 'center' },
        { text: search.start_date ? vm.dateFormat(search.start_date) : vm.$t('globalTrans.all'), style: 'td', alignment: 'left', bold: true }
      ],
      [
    ...
    const allRows = [
      [
        ...
        { text: vm.$t('globalTrans.date_of_request'), style: 'th', alignment: 'center', bold: true },
      ...
      reportData.forEach((item, index) => {
        ...
        allRows.push(
          [
            ...
            { text: item.submission_date, style: 'td', alignment: 'center' },
            { text: (i18n.locale === 'en') ? item.name : item.name_bn, style: 'td', alignment: 'center' },
            { text: zero + vm.$n(item.contact_no, { useGrouping: false }), style: 'td', alignment: 'center' },
            { text: contractStatus, style: 'td', alignment: 'center' },
            { text: item.contract_amount, style: 'td', alignment: 'center' },
