          ...
          <div class="table-responsive">
            <b-table-simple class="tg mt-3 report-table" bordered striped hover small caption-top responsive :emptyText="$t('globalTrans.noDataFound')">
              ...
              <b-tbody>
                ...
                <template v-else>
                  <b-tr>
                    <b-td class="text-center text-danger" colspan="9">{{ $t('globalTrans.noDataFound') }}</b-td>
                  </b-tr>
                </template>
              </b-tbody>
            </b-table-simple>
...
import ExportPdf from './policy_export_pdf_list'
      ...
      if (this.reportData.length > 0) {
        this.reportData.forEach((item, firstIndex) => {
          ...
          excelData.push({
            ...
            title: (this.$i18n.locale === 'en') ? item.policy_title : item.policy_title_bn,
            organization: (this.$i18n.locale === 'en') ? item.organization : item.organization_bn,
            date_of_request: dateFormat(item.submission_date),
