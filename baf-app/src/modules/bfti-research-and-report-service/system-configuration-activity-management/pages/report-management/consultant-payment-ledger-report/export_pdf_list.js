      ...
      const reportData = vm.reportData
        ...
        const allRows = [
          [
            ...
            { text: vm.$t('research_execution.consultant_name'), style: 'th', alignment: 'center', bold: true },
            { text: vm.$t('report_management.contract_date_from'), style: 'th', alignment: 'center', bold: true },
            { text: vm.$t('report_management.contract_date_to'), style: 'th', alignment: 'center', bold: true },
            { text: vm.$t('task_activity_monitoring.contract_amount'), style: 'th', alignment: 'center', bold: true }
          ]
        ]
          ...
          reportData.forEach((item, index) => {
            allRows.push(
              [
                ...
                { text: (i18n.locale === 'en') ? item.consultant_name : item.consultant_name_bn, style: 'td', alignment: 'center' },
                { text: dateFormat(item.date_from), style: 'td', alignment: 'center' },
                { text: dateFormat(item.date_to), style: 'td', alignment: 'center' },
                { text: vm.$n(item.amount, { useGrouping: false }), style: 'td', alignment: 'center' }
              ]
            )
          })
        } else {
        ...
        pdfContent.push({
          table: {
            headerRows: 1,
            widths: ['7%', '10%', '18%', '10%', '15%', '10%', '10%', '10%', '10%'],
            body: allRows
          }
        })
        pdfContent.push({ text: '', style: 'fertilizer' })
