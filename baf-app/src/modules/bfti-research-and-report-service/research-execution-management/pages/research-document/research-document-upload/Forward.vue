...
import { researchDocumentForward } from '../../../api/routes'
...
export default {
    ...
    methods: {
      async register () {
          ...
          const result = await RestApi.putData(bftiResReportServiceBaseUrl, `${researchDocumentForward}/${this.id}`, this.forward)
