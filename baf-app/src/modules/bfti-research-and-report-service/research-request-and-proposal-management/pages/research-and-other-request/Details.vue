    ...
    <b-row>
      <b-col lg="12" sm="12">
        ...
        <!-- <b-row class="text-right mt-2">
          <b-col>
              <b-button variant="success" class="btn-sm" @click="Approval(item, 1)">{{ $t('globalTrans.approved') }}</b-button>
              <b-button variant="danger" class="btn-sm ml-1" @click="Approval(item, -1)">{{ $t('globalTrans.rejected') }}</b-button>
