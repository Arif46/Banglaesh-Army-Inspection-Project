...
export default {
  ...
  methods: {
    ...
    async saveUpdate () {
      ...
      if (this.id) {
        result = await RestApi.putData(bftiResReportServiceBaseUrl, `${reportHeadUpdate}/${this.id}`, this.form)
      } else {
        result = await RestApi.postData(bftiResReportServiceBaseUrl, reportHeadStore, this.form)
      }
