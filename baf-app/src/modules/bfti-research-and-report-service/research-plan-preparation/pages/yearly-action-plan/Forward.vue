...
import { yearlyActionPlanForward } from '../../api/routes'
...
export default {
    ...
    methods: {
      async register () {
          ...
          result = await RestApi.putData(bftiResReportServiceBaseUrl, `${yearlyActionPlanForward}/${this.id}`, this.forward)
          this.$store.dispatch('mutateCommonProperties', loadinState)
          if (result.success) {
              this.$store.dispatch('AwarenessEventService/mutateCommonObj', { hasDropdownLoaded: false })
