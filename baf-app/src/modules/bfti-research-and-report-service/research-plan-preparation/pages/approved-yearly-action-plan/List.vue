  ...
  <div class="inner-section">
    <card>
      ...
      <template v-slot:searchHeaderTitle>
        <h4 class="card-title">{{ $t('globalTrans.approved') }} {{ $t('research_plan_management.yearly_action_plan') }} {{ $t('globalTrans.search') }}</h4>
      </template>
    ...
    <body-card>
      ...
      <template v-slot:headerTitle>
        <h4 class="card-title">{{ $t('globalTrans.approved') }} {{ $t('research_plan_management.yearly_action_plan') }} {{ $t('globalTrans.list') }}</h4>
      </template>
...
<script>
  ...
  import { yearlyActionPlanApprovedList, yearlyActionPlanChangeStatus } from '../../api/routes'
  ...
  export default {
    ...
    methods: {
      ...
      async loadData () {
        ...
        const result = await RestApi.getData(bftiResReportServiceBaseUrl, yearlyActionPlanApprovedList, params)
        if (result.success) {
