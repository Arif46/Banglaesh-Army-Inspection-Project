<template>
  <div class="role-select-wrapper">
    <div class="role-select">
      ...
      <h5 class="text-center mt-3 mb-2">Inspectorates Automation System</h5>
      <h5 class="text-center mt-3 mb-2">for</h5>
      <h6 class="text-center mb-3">Bangladesh Army</h6>
...
export default {
  ...
  methods: {
    ...
    roleAddUser () {
      RestApi.getData(authServiceBaseUrl, `${'auth/role-update'}/${this.selectedRole}`, {}).then(response => {
        localStorage.setItem('userDetail', response.user_detail)
      })
    },
    getComponentsByRole () {
