                ...
                <b-col md="7">
                    <div class="p-2">
                        <table width="100%">
                            ...
                            <tr>
                                <td> {{ $n(item.org_tax_info.tin_no, { useGrouping: false }) }} </td>
                            </tr>
                        </table>
                    </div>
                </b-col>
                    ...
                    <div class="pl-2 pr-2 pb-2">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td> {{ item.org_address.postal_code ? $n(item.org_address.post_code, { useGrouping: false }) : 'N/A' }}</td>
                ...
                <b-col sm="12">
                    <div class="p-2">
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td v-if="item.additional_org_address !== null"> {{ (item.additional_org_address.address_details_bn !== '' || item.additional_org_address.address_details_en !== '') ? (item.additional_org_address.address_details_bn !== null || item.additional_org_address.address_details_en !== null) ? currentLocale === 'bn' ? item.additional_org_address.address_details_bn : item.additional_org_address.address_details_en : 'N/A' : 'N/A' }} </td>
                                <td v-else> {{ 'N/A' }} </td>
                            </tr>
                        </table>
                    </div>
                    <div class="pl-2 pr-2 pb-2">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td> {{ typeof item.additional_org_address.postal_code !== 'undefined' ? $n(item.additional_org_address.postal_code, { useGrouping: false }) : 'N/A' }}</td>
                ...
                <b-col sm="12">
                    <div class="p-2">
                        <table width="100%">
                            ...
                            <tr>
                                <td> {{ $n(item.office_contact_info.telephone_no, { useGrouping: false }) }} </td>
                            </tr>
                        </table>
                    </div>
                </b-col>
