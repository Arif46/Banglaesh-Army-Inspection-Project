  ...
  try {
    ...
    const allRows = [
      [
        ...
        {},
        {},
        { text: vm.$t('cip.bangladesh_bank_opinion'), rowSpan: 3, style: 'th', alignment: 'center', bold: true },
    ...
    vm.applications.forEach((item, index) => {
      if (item.sector_id) {
        ...
        allRows.push([
          { text: vm.$t('exportTrophy.product_service_sector') + ': ' + productServiceSectorName, colSpan: 14, alignment: 'center', style: 'td' },
          {},
          {},
          {},
          {},
