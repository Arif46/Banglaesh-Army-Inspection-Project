    ...
    vm.applications.forEach((item, index) => {
      ...
      item.details.forEach((data, index1) => {
        ...
        allRows.push([
          ...
          { text: (data.profile_verification && data.profile_verification.moha_sb) ? data.profile_verification.moha_sb : '', alignment: 'center', style: 'td' },
          { text: (data.profile_verification && data.profile_verification.moha_nsi) ? data.profile_verification.moha_nsi : '', alignment: 'center', style: 'td' }
        ])
      })
    })
