...
const exportPdfDetails = async (vm) => {
    function getDesignation (vm) {
      if (vm.currentLocale === 'bn') {
        return vm.item.designation_bn !== '' ? vm.item.designation_bn : 'N/A'
      } else {
        return vm.item.designation_en !== '' ? vm.item.designation_en : 'N/A'
      }
    }
    function getName (vm) {
      if (vm.currentLocale === 'bn') {
        return vm.item.name_bn !== '' ? vm.item.name_bn : 'N/A'
      } else {
        return vm.item.name_en !== '' ? vm.item.name_en : 'N/A'
      }
    }
    function getFatherTitle (vm) {
      if (vm.currentLocale === 'bn') {
        return vm.item.father_title_bn !== '' ? vm.item.father_title_bn !== null ? vm.item.father_title_bn : 'N/A' : 'N/A'
      } else {
        return vm.item.father_title_en !== '' ? vm.item.father_title_en !== null ? vm.item.father_title_en : 'N/A' : 'N/A'
      }
    }
    function getFatherName (vm) {
      if (vm.currentLocale === 'bn') {
        return vm.item.father_name_bn !== '' ? vm.item.father_name_bn : 'N/A'
      } else {
        return vm.item.father_name_en !== '' ? vm.item.father_name_en : 'N/A'
      }
    }
    function getMotherTitle (vm) {
      if (vm.currentLocale === 'bn') {
        return vm.item.mother_title_bn !== '' ? vm.item.mother_title_bn !== null ? vm.item.mother_title_bn : 'N/A' : 'N/A'
      } else {
        return vm.item.mother_title_en !== '' ? vm.item.mother_title_en !== null ? vm.item.mother_title_en : 'N/A' : 'N/A'
      }
    }
    function getMotherName (vm) {
      if (vm.currentLocale === 'bn') {
        return vm.item.mother_name_bn !== '' ? vm.item.mother_name_bn : 'N/A'
      } else {
        return vm.item.mother_name_en !== '' ? vm.item.mother_name_en : 'N/A'
      }
    }
    function getHusbandTitle (vm) {
      if (vm.currentLocale === 'bn') {
        return vm.item.husband_title_bn !== '' ? vm.item.husband_title_bn !== null ? vm.item.husband_title_bn : 'N/A' : 'N/A'
      } else {
        return vm.item.husband_title_en !== '' ? vm.item.husband_title_en !== null ? vm.item.husband_title_en : 'N/A' : 'N/A'
      }
    }
    function getHusbandName (vm) {
      if (vm.currentLocale === 'bn') {
        return vm.item.husband_name_bn !== '' ? vm.item.husband_name_bn !== null ? vm.item.husband_name_bn : 'N/A' : 'N/A'
      } else {
        return vm.item.husband_name_en !== '' ? vm.item.husband_name_en !== null ? vm.item.husband_name_en : 'N/A' : 'N/A'
      }
    }
    function permanentAddress (vm) {
      if (vm.currentLocale === 'bn') {
        return vm.item.address.pm_address_details_bn !== '' ? vm.item.address.pm_address_details_bn !== null ? vm.item.address.pm_address_details_bn : 'N/A' : 'N/A'
      } else {
        return vm.item.address.pm_address_details_en !== '' ? vm.item.address.pm_address_details_en !== null ? vm.item.address.pm_address_details_en : 'N/A' : 'N/A'
      }
    }
    function presentAddress (vm) {
      if (vm.currentLocale === 'bn') {
        return vm.item.address.pr_address_details_bn !== '' ? vm.item.address.pr_address_details_bn !== null ? vm.item.address.pr_address_details_bn : 'N/A' : 'N/A'
      } else {
        return vm.item.address.pr_address_details_en !== '' ? vm.item.address.pr_address_details_en !== null ? vm.item.address.pr_address_details_en : 'N/A' : 'N/A'
      }
    }
      ...
      pdfContent.push({
        columns: [
          [
            ...
            { alignment: 'left', table: { widths: '100%', body: [[vm.item.nid !== '' ? vm.EngBangNum(vm.item.nid) : '']] } }
          ],
          [
            { text: vm.$n(6) + '.' + vm.$t('cip.tin'), alignment: 'left', bold: true },
            { alignment: 'left', style: 'th', table: { widths: '100%', body: [[vm.item.tax_info.tin_no !== '' ? vm.EngBangNum(vm.item.tax_info.tin_no) : '']] } }
          ]
        ],
        columnGap: 30
      })
      ...
      pdfContent.push({
        columns: [
          [
            ...
            { alignment: 'left', table: { widths: '100%', body: [[vm.item.dob !== '' ? vm.$d(new Date(vm.item.dob)) : '']] } }
          ],
          [
            { text: vm.$n(8) + '.' + vm.$t('globalTrans.gender'), alignment: 'left', bold: true },
            { alignment: 'left', style: 'th', table: { widths: '100%', body: [[vm.item.gender ? vm.genderName(vm.item.gender) : 'N/A']] } }
          ]
        ],
        columnGap: 30
      })
      ...
      pdfContent.push({
        columns: [
          [
            ...
            { alignment: 'left', table: { widths: '100%', body: [[vm.item.district_of_birth !== '' ? vm.item.district_of_birth : 'N/A']] } }
          ],
          [
            { text: vm.$n(10) + '.' + vm.$t('cip.country_of_birth'), alignment: 'left', bold: true },
            { alignment: 'left', style: 'th', table: { widths: '100%', body: [[vm.item.country_of_birth !== '' ? vm.item.country_of_birth : 'N/A']] } }
          ]
        ],
        columnGap: 30
      })
      ...
      pdfContent.push({
        columns: [
          [
            ...
            { alignment: 'left', table: { widths: '100%', body: [[vm.item.contact_info.telephone_no !== '' ? vm.EngBangNum(vm.item.contact_info.telephone_no) : '']] } }
          ]
        ]
      })
