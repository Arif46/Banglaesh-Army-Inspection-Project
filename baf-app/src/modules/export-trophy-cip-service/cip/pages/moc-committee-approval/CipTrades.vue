...
import { mocCommitteeApprovalCipTradesApi } from '../../api/routes'
...
const defaultColumn = [
  ...
  { label_en: i18n.messages.en.globalTrans.name, label_bn: i18n.messages.bn.globalTrans.name, class: 'text-left', sortable: true, stickyColumn: true, show: '1', order: 2, thStyle: { width: '30%' } },
  { label_en: i18n.messages.en.exportTrophyConfig.cip_sector, label_bn: i18n.messages.bn.exportTrophyConfig.cip_sector, class: 'text-left', sortable: true, stickyColumn: true, show: '1', order: 3, thStyle: { width: '20%' } },
  { label_en: i18n.messages.en.globalTrans.designation, label_bn: i18n.messages.bn.globalTrans.designation, class: 'text-left', sortable: true, stickyColumn: true, show: '1', order: 4, thStyle: { width: '20%' } }
]
export default {
  ...
  methods: {
    ...
    async loadData () {
      ...
      const result = await RestApi.getData(exportTrophyCIPServiceBaseUrl, mocCommitteeApprovalCipTradesApi, params)
      if (result.success) {
        const listData = result.data.data.map((item, index) => {
          ...
          return Object.assign({}, item, { serial: index }, cipSectorData)
        })
