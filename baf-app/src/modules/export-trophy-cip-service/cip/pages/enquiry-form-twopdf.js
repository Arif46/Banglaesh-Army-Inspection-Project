      ...
      pdfContent.push({
        columns: [
          ...
          [
            ...
            { alignment: 'left', style: 'th', table: { widths: '100%', body: [[vm.$n(vm.item.tax_info.tin_no, { useGrouping: false })]] } }
          ]
        ],
        columnGap: 30
      })
      ...
      pdfContent.push({
        columns: [
          [
            ...
            { alignment: 'left', table: { widths: '100%', body: [[vm.item.contact_info.telephone_no !== '' ? vm.$n(vm.item.contact_info.telephone_no, { useGrouping: false }) : '']] } }
          ]
        ]
      })
