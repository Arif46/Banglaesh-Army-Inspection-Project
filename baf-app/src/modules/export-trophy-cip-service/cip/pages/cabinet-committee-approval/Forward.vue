...
import { commApprovalForwardApi, designationWiseUser } from '../../api/routes'
...
export default {
  ...
  methods: {
    ...
    async submit () {
      ...
      result = await RestApi.postData(exportTrophyCIPServiceBaseUrl, commApprovalForwardApi, this.form)
      this.loading = false
