  ...
  <div class="inner-section">
    <card>
      ...
      <template v-slot:searchHeaderTitle>
        <h4 class="card-title">{{ $t('exportTrophyCircular.circular_publish') }} {{ $t('globalTrans.search') }}</h4>
      </template>
    ...
    <body-card>
      ...
      <template v-slot:headerTitle>
        <h4 class="card-title">{{ $t('exportTrophyCircular.circular_publish') }} {{ $t('globalTrans.list') }}</h4>
      </template>
...
import { circularPublishedListApi } from '../../api/routes'
...
export default {
  ...
  computed: {
    ...
    detailsTitle () {
      return this.$t('exportTrophyCircular.circular_publish')
    },
    pageOptions () {
  ...
  methods: {
    ...
    async loadData () {
      ...
      const result = await RestApi.getData(exportTrophyCIPServiceBaseUrl, circularPublishedListApi, params)
      if (result.success) {
