  ...
  <div class="inner-section">
    <card>
      ...
      <template v-slot:searchHeaderTitle>
        <h4 class="card-title">{{ $t('moc_portal.faq') }}</h4>
      </template>
    ...
    <body-card>
      ...
      <template v-slot:headerTitle>
        <h4 class="card-title">{{ $t('moc_portal.faq') + ' ' + $t('globalTrans.list')}}</h4>
      </template>
...
import { faqListApi, faqToggleStatusApi } from '../../api/routes'
...
const defaultColumn = [
  ...
  { label_en: i18n.messages.en.moc_portal.news, label_bn: i18n.messages.bn.moc_portal.news, class: 'text-center', sortable: true, stickyColumn: true, show: '1', order: 2, thStyle: { width: '40%' } },
  { label_en: i18n.messages.en.moc_portal.description1, label_bn: i18n.messages.bn.moc_portal.description1, class: 'text-center', sortable: true, stickyColumn: true, show: '1', order: 3, thStyle: { width: '80%' } },
...
export default {
  ...
  methods: {
    ...
    async loadData () {
      ...
      const result = await RestApi.getData(commonServiceBaseUrl, faqListApi, params)
      if (result.success) {
    ...
    remove (item) {
      this.changeStatus(1, commonServiceBaseUrl, faqToggleStatusApi, item)
    }
  }
}
</script>
