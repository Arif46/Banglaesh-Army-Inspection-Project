...
import { complainDesignationStore, complainDesignationUpdate } from '../../api/routes'
export default {
  name: 'Form',
  props: ['id'],
  data () {
  ...
  methods: {
    ...
    async saveUpdate () {
      ...
      if (this.id) {
        result = await RestApi.putData(commonServiceBaseUrl, `${complainDesignationUpdate}/${this.id}`, this.form)
      } else {
        result = await RestApi.postData(commonServiceBaseUrl, complainDesignationStore, this.form)
      }
