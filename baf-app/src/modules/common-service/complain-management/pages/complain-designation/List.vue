  ...
  <div class="inner-section">
    <card>
      ...
      <template v-slot:searchHeaderTitle>
        <h4 class="card-title">{{ $t('complain_management.complain_designation') }}</h4>
      </template>
    ...
    <body-card>
      ...
      <template v-slot:headerTitle>
        <h4 class="card-title">{{ $t('complain_management.complain_designation') }} {{ $t('globalTrans.list') }}</h4>
      </template>
...
export default {
  ...
  computed: {
    ...
    formTitle () {
      return (this.editItemId === 0) ? this.$t('complain_management.complain_designation') + ' ' + this.$t('globalTrans.entry') : this.$t('complain_management.complain_designation') + ' ' + this.$t('globalTrans.modify')
    },
    orgProfileList () {
