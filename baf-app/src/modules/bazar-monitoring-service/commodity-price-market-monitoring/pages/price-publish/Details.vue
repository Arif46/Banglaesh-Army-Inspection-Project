  ...
  <div class="inner-section">
    <card>
      ...
      <template v-slot:searchHeaderAction>
        ...
        <router-link class="btn-add" to="/bazar-monitoring-service/commodity-price-market-monitoring/price-publish"><i class="ri-arrow-left-line"></i> {{ $t('priceMonitoring.price_publish') }} {{ $t('globalTrans.list') }}</router-link>
      </template>
