        ...
        <b-card header-tag="header">
            <template #header>
                <div class="d-flex justify-content-between">
                    <h5>{{$t('eBizProposal.proposal_management')}}</h5>
                    <div class="d-flex">
                        <div class="form">
                            <b-form-select
            ...
            <b-row no-gutters>
                <b-col sm="3" class="info-card-wrapper mb-3 mb-sm-0">
                    <div class="info-item">
                        ...
                        <div class="content">
                            <p>{{ $t('eBizProposal.total_circular') }}</p>
                            <h4>{{$n(data.total_circular)}}</h4>
                        </div>
                    </div>
                </b-col>
                <b-col sm="3" class="info-card-wrapper mb-3 mb-sm-0">
                ...
                <b-col sm="3" class="info-card-wrapper mb-3 mb-sm-0">
                    <div class="info-item">
                        ...
                        <div class="content">
                            <p>{{ $t('eBizProposal.approved_proposal') }}</p>
                            <h4>{{$n(data.approved)}}</h4>
                        </div>
                    </div>
                </b-col>
                <b-col sm="3" class="info-card-wrapper mb-3 mb-sm-0">
                    <div class="info-item">
                        ...
                        <div class="content">
                            <p>{{ $t('eBizProposal.pending_proposal') }}</p>
                            <h4>{{$n(data.pending)}}</h4>
                        </div>
                    </div>
                </b-col>
            </b-row>
...
import { proposalDashCount, uidRoute } from '../api/routes'
...
export default {
  ...
  methods: {
    ...
    async searchData () {
      ...
      result = await RestApi.getData(eBizServiceBaseUrl, proposalDashCount, params)
      if (result.success) {
