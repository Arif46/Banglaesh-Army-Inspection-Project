  ...
  try {
        ...
        if (i18n.locale === 'bn') {
          ...
          const ProductWiseRowsFirst = [
            [
            { text: vm.$t('eBizReports.monitoring_report'), style: 'tablecellUni', colSpan: 5 },
          ...
          const ProductWiseRows = [
            ...
            { text: vm.$t('eBizReports.program_name'), style: 'tablecell' },
            { text: vm.$t('eBizReports.investigator_name'), style: 'tablecell' },
            { text: vm.$t('eBizReports.monitoring_date'), style: 'tablecell' }
            ]
          ]
            ...
            itemList.map((item, index) => {
              ProductWiseRows.push([
                ...
                { text: vm.currentLocale === 'en' ? item.investigator_name : item.investigator_name_bn, style: 'tablecell' },
                { text: dateFormat(item.evaluation_date), style: 'tablecell' }
              ])
            })
            pdfContent.push({
              style: 'tableExample',
