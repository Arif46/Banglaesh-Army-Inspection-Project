  ...
  try {
        ...
        if (i18n.locale === 'bn') {
          ...
          const ProductWiseRowsFirst = [
            [
             { text: vm.$t('eBizReports.financial_report'), style: 'tablecellUni', colSpan: 5 },
          ...
          const ProductWiseRows = [
            [
             ...
             { text: vm.$t('eBizReports.program_id'), style: 'tablecell' },
             { text: vm.$t('eBizReports.program_name'), style: 'tablecell' },
             { text: vm.$t('eBizReports.bpc_cost'), style: 'tablecell' },
             { text: vm.$t('eBizReports.association_cost'), style: 'tablecell' },
             { text: vm.$t('eBizReports.total_cost'), style: 'tablecell' }]
          ]
            ...
            itemList.map((item, index) => {
                ProductWiseRows.push([
                 ...
                 { text: vm.$n(item.bpc_payable_actual_expense), style: 'tablecell' },
                 { text: vm.$n(item.final_payable), style: 'tablecell' },
                 { text: vm.$n(item.total_cost), style: 'tablecell' }])
              })
            ...
            ProductWiseRows.push([
             ...
             { text: '', style: 'tablecell' },
             { text: '', style: 'tablecell' },
             { text: vm.$t('globalTrans.total'), style: 'tablecell' },
             { text: vm.$n(vm.bpcCost), style: 'tablecell' },
             { text: vm.$n(vm.associationCost), style: 'tablecell' },
             { text: vm.$n(vm.totalCost), style: 'tablecell' }])
