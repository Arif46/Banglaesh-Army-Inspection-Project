<template>
  <ValidationObserver ref="form" v-slot="{ handleSubmit, reset }">
    ...
    <b-form @submit.prevent="handleSubmit(saveUpdate)" @reset.prevent="reset" autocomplete="off">
      <b-row>
        <b-col lg="6" sm="12">
          <ValidationProvider name="Regional Office" vid="office_id" rules="required|min_value:1">
            <b-form-group
              label-for="office_id"
        ...
        <b-col sm="12">
          <ValidationProvider name="Complain Details" vid="details" rules="required" v-slot="{ errors }">
            <b-form-group
              label-for="details">
              <template v-slot:label>
