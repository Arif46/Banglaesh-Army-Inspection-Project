              ...
              <div v-if="allPayment.length">
                <div v-for="(item, key) in allPayment" :key="key" class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <ValidationProvider name="Payorder No" :vid="`challan_no`" :rules="item.is_choose_payment ? `required` : ``">
                            <b-form-group
                                class="row"
                                label-cols-sm="3"
                            ...
                            >
                                <template v-slot:label>
                                    {{ $t('externalLrcpn.payorder_no') }} <span class="text-danger">*</span>
                                </template>
                                <b-form-input
                                    id="challan_no"
...
export default {
  ...
  methods: {
      ...
      async saveFormData (type) {
          let tmpPay = {}
          tmpPay = Object.assign(this.payment, { details: this.allPayment, transId: '', paid_type: 3 })
          let result = null
          this.saveloading = true
