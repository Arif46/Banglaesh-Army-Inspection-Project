                      ...
                      <b-col lg="4" sm="4">
                          <ValidationProvider name="Organization" vid="org_id" rules="required">
                              ...
                              >
                                  ...
                                  {{$t('configuration.organization')}} <span class="text-danger">*</span>
                                  </template>
                                  <b-form-select
                                      plain
...
import { wordsToSnake } from '@/utils/fliter.js'
...
export default {
  ...
  computed: {
    ...
    menuInfo () {
      ...
      return this.$store.state.ExternalUserService.dealerPanel.commonObj.menuWiseStepList.find(item => item.id === parseInt(menuId))
    }
  },
  watch: {
  ...
  methods: {
    ...
    getServiceName () {
      const tmpService = this.$store.state.ExternalUserService.dealerPanel.commonObj.serviceNamesList.find(item => item.value === this.gridSearch.service_id)
