                ...
                <ValidationProvider :name="data.label" :vid="data.field_name" :rules="data.isRequired === true ? `required` : ``">
                    ...
                    >
                        ...
                        <button type="button" v-if="getFile(data)" class="btn btn-sm btn-success">
                            ...
                            <a target="_blank" v-else :href="bftiBaseUrl + 'uploads/bfti/' + imgData"><span style="margin: 15px 1px 15px !important; font-size: 12px">{{ $t('externalLrcpn.view_attachment') }}</span></a>
                        </button>
