                        ...
                        <template slot="footer" slot-scope="props">
                            <div class="wizard-footer-right">
                                ...
                                <wizard-button
                                    ...
                                    title="Cancel"
                                >
                                    <router-link to="/tea-garden-panel/tea-farmer-application" class="text-white"><i class="ri-close-circle-line"></i> {{ $t('globalTrans.cancel') }}</router-link>
                                </wizard-button>
                            </div>
                        </template>
                    </form-wizard>
...
export default {
  ...
  methods: {
    ...
    async tabOwnerInfo () {
        ...
        if (result.success) {
            if (this.draft) {
                this.$router.push({ path: '/tea-garden-panel/tea-farmer-application' })
            } else {
                this.$router.push({ path: '/tea-garden-panel/tea-farmer-application' })
            }
        }
