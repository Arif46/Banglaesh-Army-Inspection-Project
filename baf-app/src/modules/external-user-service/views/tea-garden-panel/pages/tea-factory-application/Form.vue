                    ...
                    <form-wizard shape="circle" color="#005B5B" title="" subtitle="" :start-index.sync="activeIndex">
                        <tab-content :title="$t('teaGardenPanel.applicant_tab')" icon="ri-user-location-fill" :before-change="tabSubmitApplicant">
                            <div class="application-itmes">
                                 <ApplicantForm :key="key" :app_id="app_id" :applicantFormData="application" :isShow="dataLoaded" :baseUrl="baseUrl" :isRenew="false" ref="applicant_form"/>
                            </div>
                        </tab-content>
                        ...
                        <tab-content :title="$t('teaGardenPanel.machineries_tab')" icon="ri-file-info-fill" :before-change="tabMachineriesInfo">
                            <div class="application-itmes">
                                 <MachineriesInfo :key="key" :app_id="app_id" :machineriesInfoData="application.machineries_info" :isRenew="false" ref="machineries_info_form"/>
                            </div>
                        </tab-content>
                        <tab-content :title="$t('teaGardenPanel.attachment_tab')" icon="ri-attachment-line" :before-change="tabAttachmentInfo">
                            <div class="application-itmes">
                                 <AttachmentInfo :key="key" :app_id="app_id" :attachmentInfoData="application.attachment_file" :attachmentAddMoreData="application.add_more_files" :allData="application" :draft="draft" :isRenew="false" ref="attachment_file_form"/>
                            </div>
                        </tab-content>
