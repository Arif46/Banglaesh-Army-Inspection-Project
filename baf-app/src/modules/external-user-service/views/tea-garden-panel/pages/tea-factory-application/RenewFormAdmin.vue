<template>
                          ...
                          <template slot="footer" slot-scope="props">
                              <div class="wizard-footer-right">
                                  ...
                                  <wizard-button
                                      ...
                                      title="Cancel"
                                  >
                                      <router-link to="/tea-garden-service/btb/tea-factory-application" class="text-white"><i class="ri-close-circle-line"></i> {{ $t('globalTrans.cancel') }}</router-link>
                                  </wizard-button>
                              </div>
                          </template>
                      </form-wizard>
  ...
  methods: {
    ...
    async tabSubmitApplicant () {
        ...
        if (result.success) {
            if (this.draft) {
                this.$router.push({ path: '/tea-garden-service/btb/tea-factory-application' })
            } else {
