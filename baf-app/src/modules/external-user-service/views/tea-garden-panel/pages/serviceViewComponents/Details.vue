                          ...
                          <b-col sm="12">
                            ...
                            <div>
                              ...
                              <div class="application-form-wrapper application-form-view-wrapper mt-5">
                                <div>
                                  <h5
                                    style="border-bottom: 2px solid #2f3542;width: 65%;margin: 3rem auto;padding-bottom: 5px;text-align: center;">Tea Estate/Tea Garden/Small Tea Garden Registration</h5>
                                </div>
                                <div class="application-itmes">
                                  <div class="group-form-card">
                                    <b-form-group label-cols-lg="3" label="Applicant info" label-size="md"
                                      label-class="font-weight-bold pt-0" class="form-view-item">
                                      <b-row>
                                        <b-col sm="6">
                                          <b-form-group label="Applicant Name:" label-for="ApplicantNameEn">
                                            <p class="input-field">Md. Tawhiduzzaman</p>
                                          </b-form-group>
                                        </b-col>
                                        <b-col sm="6">
                                          <b-form-group label="Designation:" label-for="DesignationEn">
                                            <p class="input-field">Chief Executive Officer</p>
                                          </b-form-group>
                                        </b-col>
                                      </b-row>
                                    </b-form-group>
                                  ...
                                  <div class="group-form-card">
                                    <b-form-group label-cols-lg="3" label="Garden Address" label-size="md"
                                      label-class="font-weight-bold pt-0" class="form-view-item">
                                      <b-row>
                                        <b-col sm="6">
                                          <b-form-group label="Tea Garden Name:" label-for="TeaGardenNameEn">
                                            <p class="input-field">Malnichhera Tea Garden</p>
                                          </b-form-group>
                                        </b-col>
                                        <b-col sm="6">
                                          <b-form-group label="Area Type:" label-for="AreaType">
                                            <p class="input-field">City Corporation</p>
                                          </b-form-group>
                                        </b-col>
                                        ...
                                        <b-col sm="6">
                                          <b-form-group label="Ward:" label-for="Ward">
                                            <p class="input-field">10</p>
                                          </b-form-group>
                                        </b-col>
                                        <b-col sm="6">
                                          <b-form-group label="Post Code:" label-for="PostCode">
                                            <p class="input-field">1216</p>
                                          </b-form-group>
                                        </b-col>
                                        <b-col sm="6">
