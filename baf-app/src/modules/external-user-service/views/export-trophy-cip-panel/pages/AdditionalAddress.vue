    ...
    <div>
        <b-row :class="param.noMargin ? null : 'mt-4'">
            ...
            <b-col :xl="param.xl" :lg="param.lg" :md="param.md" sm="12">
                <ValidationProvider name="Area Type" vid="area_type_id" :rules="param.isAreaTypeNullable ? null : ''" v-slot="{ errors }">
                    <b-form-group
                        class="row"
                        :label-cols-sm="param.labelCols"
            ...
            <!-- Division -->
            <b-col :xl="param.xl" :lg="param.lg" :md="param.md" sm="12">
                <ValidationProvider name="Division" vid="division_id" :rules="param.isDivisionNullable ? null : ''" v-slot="{ errors }">
                    <b-form-group
                        class="row"
                        :label-cols-sm="param.labelCols"
            ...
            <!-- District -->
            <b-col :xl="param.xl" :lg="param.lg" :md="param.md" sm="12">
                <ValidationProvider name="District" vid="district_id" :rules="param.isDistrictNullable ? null : ''" v-slot="{ errors }">
                    <b-form-group
                        class="row"
                        :label-cols-sm="param.labelCols"
            ...
            <b-col :xl="param.xl" :lg="param.lg" :md="param.md" sm="12" v-if="CityCorpItemShow">
                <ValidationProvider name="City Corporation" vid="city_corporation_id" :rules="param.isCityCorporationNullable ? null : ''" v-slot="{ errors }">
                    <b-form-group
                        class="row"
                        :label-cols-sm="param.labelCols"
            ...
            <b-col :xl="param.xl" :lg="param.lg" :md="param.md" sm="12" v-if="PauroshobaItemShow || UnionItemShow">
                <ValidationProvider name="Upazila" vid="upazila_id" :rules="param.isUpazilaNullable ? null : ''" v-slot="{ errors }">
                    <b-form-group
                        class="row"
                        :label-cols-sm="param.labelCols"
            ...
            <b-col :xl="param.xl" :lg="param.lg" :md="param.md" sm="12" v-if="PauroshobaItemShow">
                <ValidationProvider name="Pourashava" vid="paurashava_id" :rules="param.isPaurashavaNullable ? '' : ''" v-slot="{ errors }">
                    <b-form-group
                        class="row"
                        :label-cols-sm="param.labelCols"
            ...
            <b-col :xl="param.xl" :lg="param.lg" :md="param.md" sm="12" v-if="UnionItemShow">
                <ValidationProvider name="Union" vid="union_id" :rules="param.isUnionNullable ? null : ''" v-slot="{ errors }">
                    <b-form-group
                        class="row"
                        :label-cols-sm="param.labelCols"
                        label-for="union_id"
            ...
            <b-col v-if="!param.noPostalCode" :xl="param.xl" :lg="param.lg" :md="param.md" sm="12">
                <ValidationProvider name="Postal Code" vid="postal_code" v-slot="{ errors }">
                    <b-form-group
                        :label-cols-sm="param.labelCols"
...
export default {
    ...
    mounted () {
        if (this.data && Object.values(this.data).length > 0) {
            ...
            this.address.postal_code = this.data.postal_code
