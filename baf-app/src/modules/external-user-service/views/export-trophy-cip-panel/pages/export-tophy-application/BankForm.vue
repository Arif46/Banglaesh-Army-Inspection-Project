        ...
        <ValidationObserver ref="form1"  v-slot="{ handleSubmit, reset }">
            <b-form @submit.prevent="handleSubmit(addItem)" @reset.prevent="reset">
                <b-overlay :show="loading">
                    ...
                    <b-row>
                      <b-col lg="6" sm="12">
                        <ValidationProvider name="Bank Name (En)" vid="bank_name_en" rules="required|max:100" v-slot="{ errors }">
                          <b-form-group
                      ...
                      <b-col lg="6" sm="12">
                        <ValidationProvider name="Bank Name (Bn)" vid="bank_name_bn" rules="required|max:100" v-slot="{ errors }">
                          <b-form-group
                      ...
                      <b-col lg="6" sm="12">
                        <ValidationProvider name="Branch Name (En)" vid="branch_name_en" rules="required|max:100" v-slot="{ errors }">
                          <b-form-group
                      ...
                      <b-col lg="6" sm="12">
                        <ValidationProvider name="Branch Name (Bn)" vid="branch_name_bn" rules="required|max:100" v-slot="{ errors }">
                          <b-form-group
                      ...
                      <b-col lg="6" sm="12">
                          <ValidationProvider name="Address (En)" vid="address_en" rules="required|max:255" v-slot="{ errors }">
                            <b-form-group
                              label-cols-sm="5"
                        ...
                        <b-col lg="6" sm="12">
                          <ValidationProvider name="Address (Bn)" vid="address_bn" rules="required|max:255" v-slot="{ errors }">
                            <b-form-group
                              label-cols-sm="5"
