        ...
        <ValidationObserver ref="form"  v-slot="{ handleSubmit, reset }">
            <b-form @submit.prevent="handleSubmit(submit)" @reset.prevent="reset">
              <b-row>
                  ...
                  <b-col xl="6" lg="6" sm="12">
                    <ValidationProvider name="Merchandising PRC" vid="other_compliance.merchandising_prc" :rules="!$route.query.id || other_compliance.merchandising_prc === '' ? 'required|size:2048' : ''" v-slot="{ errors }">
                        <b-form-group
                          label-for="other_compliance.merchandising_prc"
                          label-cols-sm="5"
                        >
                        <template v-slot:label>
                          {{ $t('externalUser.merchandising_prc')}} <span v-if="!$route.query.id || other_compliance.merchandising_prc === ''" class="text-danger">*</span> <span class="text-danger" style="font-size:10px;"><br/> {{ $t('externalUser.attachment_type')}}</span>
                  ...
                  <b-col xl="6" lg="6" sm="12">
                    ...
                    :rules="!$route.query.id || other_compliance.report === '' ? 'required' : ''" v-slot="{ errors }">
                        ...
                        <template v-slot:label>
                          ...
                          <span v-if="!$route.query.id || other_compliance.report === ''" class="text-danger">*</span>  <span class="text-danger" style="font-size:10px;"><br/> {{ $t('externalUser.attachment_type')}}</span>
                ...
                <b-col v-if="parseInt(other_compliance.dispute_settled) === 1" xl="12" lg="12" sm="12">
                  <b-col xl="6" lg="6" sm="12">
                      <ValidationProvider name="Dispute Settled Document" vid="dispute_settled_document" :rules="!$route.query.id || other_compliance.dispute_settled_document === '' || other_compliance.dispute_settled_document === null ? 'required' : ''" v-slot="{ errors }">
                          ...
                          >
                          <template v-slot:label>
                            {{ $t('externalUser.dispute_settled_document')}} <span v-if="!$route.query.id || other_compliance.dispute_settled_document === '' || other_compliance.dispute_settled_document === null" class="text-danger">*</span>  <span class="text-danger" style="font-size:10px;"><br/> {{ $t('externalUser.attachment_type')}}</span>
