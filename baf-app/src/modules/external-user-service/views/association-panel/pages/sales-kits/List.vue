  ...
  <div class="inner-section">
    <card>
      ...
      <template v-slot:searchHeaderTitle>
        <h4 class="card-title">{{ $t('eBizPromotional.sales_kits') }} {{$t('globalTrans.search')}}</h4>
      </template>
    ...
    <body-card>
      ...
      <template v-slot:headerTitle>
        <h4 class="card-title">{{ $t('eBizPromotional.sales_kits') }}</h4>
      </template>
...
import { salesKitsAdvertisementList } from '../../api/routes'
...
export default {
  ...
  methods: {
    ...
    async loadData () {
      ...
      const result = await RestApi.getData(eBizServiceBaseUrl, salesKitsAdvertisementList, params)
      if (result.success) {
