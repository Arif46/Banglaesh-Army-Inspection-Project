       ...
       <b-row style="line-height: 20px">
            <template>
                <b-row>
                    ...
                    <b>{{$t('eBizConfig.description')}} {{ $t('globalTrans.en') }} </b>:
                        <span v-html="items.description_en"></span>
                    </b-col>
                        <b-col md="12" v-if="$i18n.locale === 'bn'">
                        <b>{{$t('eBizConfig.description')}} {{ $t('globalTrans.bn') }} </b>:
                    ...
                    <span v-if="items.attachment_main">
                        <a target="_blank" :href="eBizServiceBaseUrl+'download-attachment?file='+items.attachment_main" title="Download">
                    ...
                    <span v-if="items.attachment_one">
                        <a target="_blank" :href="eBizServiceBaseUrl+'download-attachment?file='+items.attachment_one" title="Download">
                    ...
                    <span v-if="items.attachment_two">
                        <a target="_blank" :href="eBizServiceBaseUrl+'download-attachment?file='+items.attachment_two" title="Download">
                    ...
                    <span v-if="items.attachment_three">
                        <a target="_blank" :href="eBizServiceBaseUrl+'download-attachment?file='+items.attachment_three" title="Download">
                    ...
                    <span v-if="items.attachment_four">
                        <a target="_blank" :href="eBizServiceBaseUrl+'download-attachment?file='+items.attachment_four" title="Download">
