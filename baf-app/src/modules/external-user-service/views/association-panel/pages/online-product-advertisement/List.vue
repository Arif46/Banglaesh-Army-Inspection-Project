  ...
  <div class="inner-section">
    <card>
      ...
      <template v-slot:searchHeaderTitle>
        <h4 class="card-title">{{ $t('eBizPromotional.online_product') }} {{$t('globalTrans.search')}}</h4>
      </template>
    ...
    <body-card>
      ...
      <template v-slot:headerTitle>
        <h4 class="card-title">{{ $t('eBizPromotional.online_product') }}</h4>
      </template>
...
import { onlineProductAdvertisementList } from '../../api/routes'
...
export default {
  ...
  methods: {
    ...
    async loadData () {
      ...
      const result = await RestApi.getData(eBizServiceBaseUrl, onlineProductAdvertisementList, params)
      if (result.success) {
