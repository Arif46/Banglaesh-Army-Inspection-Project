                                ...
                                <template>
                                    <div
                                        ...
                                        <h5 class="card-title text-center"
                                            ...
                                            $t('teaGardenConfig.designation') }} {{ $t('globalTrans.details') }}</h5>
                                    </div>
                                </template>
                                <table class="table table-borderless">
                                    <tr>
                                        <th style="width: 25%"> {{$t('teaGardenConfig.designation_name')}}</th>
                                        <th style="width: 2%">:</th>
                                        <td style="width: 70%">{{ ($i18n.locale === 'bn') ? item.designation_name_bn :
                                        item.designation_name_en }}</td>
                                    </tr>
                                </table>
                            </b-col>
                        </b-row>
