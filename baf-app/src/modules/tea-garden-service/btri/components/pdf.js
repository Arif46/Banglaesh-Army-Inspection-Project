      ...
      Store.commit('mutateCommonProperties', {
        ...
        pdfContent.push({
          ...
          table: {
            ...
            body: [
              ...
              [{ text: vm.$t('dealer.email') }, { text: appDetail.details.email }, { text: vm.$t('dealer.tin_no') }, { text: appDetail.details.tin_no }],
              [{ text: vm.$t('dealer.mobile'), style: 'tableHeaderFive' }, { text: mobileNumber(appDetail.details.mobile), colSpan: 2 }, '', '']
            ]
          },
          layout: {
        ...
        pdfContent.push({
          ...
          table: {
            widths: ['20%', '30%', '20%', '30%'],
            body: [
              [{ text: vm.$t('allocation_management.dealer_type') }, { text: vm.getDealerType(appDetail.dealer_type) }, { text: vm.$t('dealer.company_name') }, { text: vm.$i18n.locale === 'bn' ? appDetail.details.company_name_bn : appDetail.details.company_name }],
              [{ text: vm.$t('globalTrans.division') }, { text: vm.getDivisionName(appDetail.details.company_division_id) }, { text: vm.$t('globalTrans.district') }, { text: vm.getDistrictName(appDetail.details.company_district_id) }],
              [{ text: vm.$t('globalTrans.upazila') }, { text: vm.getUpazillaName(appDetail.details.company_upazilla_id) }, { text: vm.$t('globalTrans.office') }, { text: vm.getOfficeName(appDetail.office_id) }]
            ]
          },
          layout: {
            fillColor: function (rowIndex, node, columnIndex) {
