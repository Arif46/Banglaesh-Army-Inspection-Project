    ...
    <body-card>
      ...
      <template v-slot:body>
        ...
        <div class="apps-subject-wrapper mb-4">
          <p>{{ $t('teaGardenBtriService.director_label') }}</p>
          <p>{{ $t('teaGardenBtriService.btb_label') }}</p>
          <p>{{ $t('teaGardenBtriService.upazila_label') }}</p>
          <p>{{ $t('globalTrans.district') }}- {{ $t('teaGardenBtriService.district_name') }}</p>
        </div>
        ...
        <div class="cover-letter-wrapper" style="text-align: justify">
          ...
          <p style="line-height: 2rem;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $t('teaGardenBtriService.greeting_heading') }} <span class="dynamic-line-wrapper">{{ getGardenName(appDetails.garden_id) }}</span> {{ $t('teaGardenBtriService.tea_sample_taste_end_label') }}
         </p>
        </div>
        <b-col sm="12 mt-5">
