      ...
      const pdfContent = [
        ...
        allRows.push(
          ...
          [
            ...
            { text: ':', alignment: 'center' },
            { text: detailsData.land_ownership_info.mouja, style: 'td', alignment: 'left', bold: false }
          ],
          [
        ...
        pdfContent.push(
          { text: vm.$t('teaGardenPanel.conditions'), bold: true, margin: [0, 5, 0, 5] },
          { text: vm.$n(1) + ') ' + vm.$t('teaGardenPanel.condition1') + ';', style: 'td', alignment: 'justify' },
          { text: vm.$n(2) + ') ' + vm.$t('teaGardenPanel.condition2') + ';', style: 'td', alignment: 'justify' },
          { text: vm.$n(3) + ') ' + vm.$t('teaGardenPanel.condition3') + ';', style: 'td', alignment: 'justify' },
          { text: vm.$n(4) + ') ' + vm.$t('teaGardenPanel.condition4') + ';', style: 'td', alignment: 'justify' },
          { text: vm.$n(5) + ') ' + vm.$t('teaGardenPanel.condition5') + ';', style: 'td', alignment: 'justify' },
          { text: vm.$n(6) + ') ' + vm.$t('teaGardenPanel.condition6') + ';', style: 'td', alignment: 'justify', pageBreak: 'after' }
        )
        const signatureRows = [
          [
            {
          ...
          [
            {},
            { text: vm.$t('globalTrans.name') + ' : ' + vm.$t('teaGardenPanel.signatory_name'), style: 'td', alignment: 'left', bold: true }
          ],
          [
            {},
            { text: vm.$t('globalTrans.designation') + ' : ' + vm.$t('teaGardenPanel.signatory_designation'), style: 'td', alignment: 'left', bold: true }
          ],
          [
            {},
            { text: vm.$t('globalTrans.date') + ' : ' + vm.$t('teaGardenPanel.signatory_date'), style: 'td', alignment: 'left', bold: true }
          ]
        ]
        pdfContent.push({
          table: {
