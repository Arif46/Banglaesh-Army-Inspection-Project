                  ...
                  <table class="payment-info">
                    <tbody>
                      <tr>
                        ...
                        <td><span> {{ data.circular !== undefined ? $n(data.circular.course_fee) : '' }}</span></td>
                      </tr>
                    </tbody>
                  </table>
                </b-card>
...
<script>
  ...
  import { applicationPaymentOffline, applicationPaymentOnline, applicantInfoShowApi } from '../../../api/routes'
  ...
  export default {
    ...
    methods: {
      async getData (id) {
          this.loading = true
          let result = null
          result = await RestApi.getData(teaGardenServiceBaseUrl, `${applicantInfoShowApi}/${id}`)
