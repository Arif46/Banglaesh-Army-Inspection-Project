<template>
       ...
       <b-col lg="12" sm="12">
           <b-overlay :show="loader">
              ...
              <b-table-simple bordered>
                ...
                <b-tbody>
                    <b-tr v-for="(item, index) in data.details[0].stall_numbers" :key="index">
                        <b-td>
                            {{ $n(index + 1) }}
                        </b-td>
                        <b-td>
  ...
  export default {
    ...
    methods: {
      ...
      async getStallInfo () {
        this.loader = true
        const params = Object.assign({ year: this.data.year, circular_type: this.data.circular_type, fair_id: this.data.fair_id })
        const response = await RestApi.getData(internationalTradeFairServiceBaseUrl, stallInfoShow, params)
        if (response.success) {
          this.loader = false
