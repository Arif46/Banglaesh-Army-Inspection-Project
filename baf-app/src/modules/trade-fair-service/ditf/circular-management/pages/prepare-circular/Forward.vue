...
import { prepareCircularForward, userListByDesignationApi } from '../../api/routes'
export default {
  name: 'Form',
  props: ['item'],
  data () {
  ...
  methods: {
    ...
    async saveUpdate () {
      ...
      result = await RestApi.postData(internationalTradeFairServiceBaseUrl, prepareCircularForward, this.form)
