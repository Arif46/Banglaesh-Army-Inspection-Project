...
import { prepareCircularApproveReturn } from '../../api/routes'
export default {
  name: 'Form',
  props: ['id', 'status'],
  data () {
  ...
  methods: {
    async saveUpdate () {
      ...
      result = await RestApi.postData(internationalTradeFairServiceBaseUrl, prepareCircularApproveReturn, this.formData)
