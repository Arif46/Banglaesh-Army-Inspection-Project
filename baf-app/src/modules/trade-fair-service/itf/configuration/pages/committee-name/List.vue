  ...
  <div class="inner-section">
    <card>
      ...
      <template v-slot:searchHeaderTitle>
        <h4 class="card-title">{{ $t('tradeFairConfig.committee_name_l') }} {{ $t('globalTrans.search') }}</h4>
      </template>
    ...
    <body-card>
      ...
      <template v-slot:headerTitle>
        <h4 class="card-title">{{ $t('tradeFairConfig.committee_name_list') }}</h4>
      </template>
...
import { committeeNameList, committeeNameToggle } from '../../api/routes'
...
const defaultColumn = [
  ...
  { label_en: i18n.messages.en.tradeFairConfig.committee_type, label_bn: i18n.messages.bn.tradeFairConfig.committee_type, class: 'text-center', sortable: true, stickyColumn: true, show: '1', order: 2, thStyle: { width: '25%' } },
  { label_en: i18n.messages.en.tradeFairConfig.committee_name, label_bn: i18n.messages.bn.tradeFairConfig.committee_name, class: 'text-center', sortable: true, stickyColumn: true, show: '1', order: 3, thStyle: { width: '25%' } },
  ...
  { label_en: i18n.messages.en.globalTrans.action, label_bn: i18n.messages.bn.globalTrans.action, class: 'text-center', show: '1', order: 5, thStyle: { width: '15%' } }
]
export default {
  ...
  computed: {
    ...
    formTitle () {
      return (this.editItemId === 0) ? this.$t('tradeFairConfig.committee_name') + ' ' + this.$t('globalTrans.entry') : this.$t('tradeFairConfig.committee_name') + ' ' + this.$t('globalTrans.modify')
    },
    pageOptions () {
  ...
  methods: {
    remove (item) {
      this.changeStatus(9, internationalTradeFairServiceBaseUrl, committeeNameToggle, item)
    },
    searchData () {
      this.loadData()
    },
    async loadData () {
      ...
      const result = await RestApi.getData(internationalTradeFairServiceBaseUrl, committeeNameList, params)
      if (result.success) {
