  ...
  <div class="inner-section">
    <card>
      ...
      <template v-slot:searchHeaderTitle>
        <h4 class="card-title">{{ $t('approvedParticipation.approved_participation') }} {{ $t('globalTrans.search') }}</h4>
      </template>
    ...
    <body-card>
      ...
      <template v-slot:headerTitle>
        <h4 class="card-title">{{ $t('approvedParticipation.approved_participation') }} {{ $t('globalTrans.list') }}</h4>
      </template>
...
import { approvedParticipantList } from '../../api/routes'
