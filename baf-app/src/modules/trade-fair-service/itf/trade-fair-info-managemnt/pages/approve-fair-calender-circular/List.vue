  ...
  <div class="inner-section">
    <card>
      ...
      <template v-slot:searchHeaderTitle>
        <h4 class="card-title">{{ $t('tradeFairInfoManagement.approve_fair_calender_circular') }} {{ $t('globalTrans.search') }}</h4>
      </template>
    ...
    <body-card>
      ...
      <template v-slot:headerTitle>
        <h4 class="card-title">{{ $t('tradeFairInfoManagement.approve_fair_calender_circular') }}  {{ $t('globalTrans.list') }}</h4>
      </template>
...
import { fairCalenderCircularApproveList } from '../../api/routes'
...
export default {
  ...
  methods: {
    ...
    async loadData () {
      ...
      const result = await RestApi.getData(internationalTradeFairServiceBaseUrl, fairCalenderCircularApproveList, params)
      if (result.success) {
