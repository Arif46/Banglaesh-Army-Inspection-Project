  ...
  <ValidationObserver ref="form" v-slot="{ handleSubmit, reset }">
    ...
    <b-form @submit.prevent="handleSubmit(saveUpdate)" @reset.prevent="reset" autocomplete="off">
      <b-row>
        ...
        <b-col sm="4">
          <ValidationProvider name="Officer Name" vid="receiver_id" rules="">
            <b-form-group
        ...
        <!-- <b-col sm="6">
          <ValidationProvider name="Forward Date" vid="forward_date" rules="">
            <b-form-group
...
import { calenderForwardStoreApi, userListByDesignationApi } from '../../api/routes'
export default {
  name: 'Form',
  props: ['items'],
  data () {
  ...
  created () {
    if (this.items) {
      this.form.circular_id = this.items.calendar.circular_id
  ...
  methods: {
    ...
    async saveUpdate () {
      ...
      result = await RestApi.postData(internationalTradeFairServiceBaseUrl, calenderForwardStoreApi, this.form)
