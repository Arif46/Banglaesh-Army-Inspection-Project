  ...
  <ValidationObserver ref="form" v-slot="{ handleSubmit, reset }">
    ...
    <b-form @submit.prevent="handleSubmit(saveUpdate)" @reset.prevent="reset" autocomplete="off">
      <b-row>
        ...
        <b-col sm="6">
          <ValidationProvider name="Comment (En)" vid="comment_en" rules="max:255">
            <b-form-group
        ...
        <b-col sm="6">
          <ValidationProvider name="Comment (Bn)" vid="comment_bn" rules="max:255">
            <b-form-group
...
import { itfFairPartiForward, userListByDesignationApi } from '../../api/routes'
export default {
  name: 'Form',
  props: ['item'],
  data () {
  ...
  created () {
    if (this.item) {
      this.form.part_circular_id = this.item.id
  ...
  methods: {
    ...
    async saveUpdate () {
      ...
      result = await RestApi.postData(internationalTradeFairServiceBaseUrl, itfFairPartiForward, this.form)
