...
import { itfFairExhibitCircularApproveReturn } from '../../api/routes'
export default {
  name: 'Form',
  props: ['id', 'status'],
  data () {
  ...
  methods: {
    async saveUpdate () {
      ...
      result = await RestApi.postData(internationalTradeFairServiceBaseUrl, itfFairExhibitCircularApproveReturn, this.formData)
