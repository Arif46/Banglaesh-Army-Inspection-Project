...
import { exhibitionApproveReturnApi } from '../../api/routes'
export default {
  name: 'Form',
  ...
  created () {
   if (this.selectedItem) {
      this.formData.exhibitionIds = this.selectedItem
  ...
  methods: {
    async saveUpdate () {
      ...
      result = await RestApi.postData(internationalTradeFairServiceBaseUrl, exhibitionApproveReturnApi, this.formData)
