...
//            $extension = explode('/', mime_content_type($file))[1];
    ...
    public static function uploadFile($request, $fieldName, $destinationPath, $oldFile = null, $fileSize = null)
    {
        if (Str::contains($request[$fieldName], 'data:image')) {
            return self::uploadImage($request, $fieldName, $destinationPath, $oldFile, null, null, $fileSize, true);
        }
     ...
     * @return array
     */
    public static function uploadImage($request, $fieldName, $destinationPath = '/uploads', $oldFile = null, $width = null, $height = null, $fileSize = null, $hasStorege = false )
    {
